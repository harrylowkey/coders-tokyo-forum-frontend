                  ...
                  <v-row>
                    <v-col cols="4" offset-sm="4" class="py-1">
                      <div class="d-flex flex-column align-center">
                        <user-avatar
                          :src="'https://res.cloudinary.com/hongquangraem/image/upload/v1587195917/Coders-Tokyo-Forum/posts/javascript.png.png'"
                              ...
                              <v-row class="mt-5">
                                <v-col cols="12" sm="12" md="4">
                                  ...
                                  <div style="flex: 26%" class="d-flex flex-column align-center">
                                    ...
                                    >
                                      <v-img max-width="210" max-height="210" :src="bannerImage"></v-img>
                                      <v-chip
                                        @click="uploadBanner = !uploadBanner"
                                        text-color="#fff"
                                        class="upload-btn"
...
export default {
  ...
  created() {
    ...
    this.addComposer2 = this.composer2 ? true : false;
