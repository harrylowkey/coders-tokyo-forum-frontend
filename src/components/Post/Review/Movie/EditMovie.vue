  ...
  methods: {
    ...
    async fetchPost() {
      this.getPostById({
        ...
        this.updateGenres = [...this.post.movie.genres];
      });
    },
    ...
    async submit() {
      ...
      this.post.movie.genres = this.updateGenres;
      const dataUpdate = {
