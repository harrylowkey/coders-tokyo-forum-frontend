<template>
  <v-container class="d-flex pt-0 flex-wrap justify-center mb-3 pt-4" id="wrapper">
    <v-container v-for="post in data" :key="post._id" :style="calWidth(post.type)">
      <discussion
