    ...
    <v-card color="basil">
      <v-tabs v-model="tab" grow>
        ...
        <v-menu offset-y open-on-hover>
          ...
          <v-list>
            <v-list-item v-for="(item, index) in blogMenus" :key="index" @click="setActivePage(item.category)">
        ...
        <v-menu offset-y open-on-hover>
          ...
          <v-list>
            <v-list-item v-for="(item, index) in audioMenus" :key="index" @click="setActivePage(item.category)">
              <v-list-item-icon class="mr-2">
